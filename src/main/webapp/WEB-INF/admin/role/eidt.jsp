        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="${base}/role/update" method="post" class="row">
                        <input name="id" value="${role.id}" style="display:none;">
                        <div class="form-group col-md-12">
                            <label for="name">角色名</label>
                            <input type="text" class="form-control" id="name" name="reloname" value="${role.reloname}"
                                   placeholder="角色名"/>
                        </div>
                            ...
                            <div class="clearfix">
                                <label class="lyear-radio radio-inline radio-primary">
                                    <input type="radio" name="status"
                                           <c:if test="${role.status eq 1}">checked</c:if> value="1"><span>禁用</span>
                                </label>
                                <label class="lyear-radio radio-inline radio-primary">
                                    <input type="radio" name="status"
                                           <c:if test="${role.status eq 0}">checked</c:if> value="0"><span>启用</span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group col-md-12">
